...
const Store = React.memo(() => {
  const [_, setActive] = useAtom(activePageAtom);
  ...
  return (
    ...
    >
      ...
      <button
        className="w-[335px] h-[60px] px-[11px] py-[8px] flex items-center rounded-[58px] absolute bottom-[31px] left-[35px] bg-[#EBFCF5] bg-opacity-10"
        onClick={goToStore}
      >
        <img src={GoStoreIcon} />
